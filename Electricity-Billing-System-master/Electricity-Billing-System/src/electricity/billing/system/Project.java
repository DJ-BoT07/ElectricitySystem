...
/*
 * The Project class serves as the main entry point for the application and
 * provides the main user interface with various menu options for different
 * functionalities. The ActionListener interface is used to handle menu item
 * clicks and open corresponding frames or execute external applications (e.g.,
 * Notepad, Calculator).
 */
