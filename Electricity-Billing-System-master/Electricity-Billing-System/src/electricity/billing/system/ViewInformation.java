...
public class ViewInformation extends JFrame implements ActionListener {
    ...
    ViewInformation(String meter) {
        ...
        // Display customer's meter number
        ...
        try {
            // Fetch customer information from the database based on the meter number
            Conn c = new Conn();
            ...
            if (rs.next()) {
                ...
                JOptionPane.showMessageDialog(null, "No customer found with the given meter number.");
                setVisible(false);
            }
        } catch (Exception e) {
            e.printStackTrace();
